...
export function testCryptoShuffleTC004(): void {
    ...
    try {
        ...
        assert.deepStrictEqual(originalArray, [], `[${testID}] Failed: Original array content was modified.`)
        assert.deepStrictEqual(returnedArray, [], `[${testID}] Failed: Returned array content was modified.`)
